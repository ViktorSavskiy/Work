<?php 
$work = [];
$work[0] = ["name" => "Developer", "data" => "March", "expir" => "2 day"];
$work[1] = ["name" => "Dev", "data" => "March 13", "expir" => "4 day"];
$work[2] = ["name" => "loper", "data" => "March 14", "expir" => "3 day"];
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[$i]["date"]; ?> </h6>
          <p><?php echo $work[$i]["expir"]; ?></p>
          <hr>
        </div>
       <?php }?>
